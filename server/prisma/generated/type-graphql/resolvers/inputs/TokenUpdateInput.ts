...
import { UserUpdateOneWithoutTokensNestedInput } from "../inputs/UserUpdateOneWithoutTokensNestedInput";
...
export class TokenUpdateInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateOneWithoutTokensNestedInput, {
    nullable: true
  })
  user?: UserUpdateOneWithoutTokensNestedInput | undefined;
}
