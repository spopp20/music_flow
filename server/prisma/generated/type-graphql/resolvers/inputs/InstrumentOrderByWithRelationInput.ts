...
@TypeGraphQL.InputType("InstrumentOrderByWithRelationInput", {
  isAbstract: true
})
export class InstrumentOrderByWithRelationInput {
  ...
  songs?: InstrumentSongOrderByRelationAggregateInput | undefined;
}
